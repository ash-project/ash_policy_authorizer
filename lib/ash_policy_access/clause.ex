# defmodule AshPolicyAccess.Clause do
...
#   def find(_clauses, %{check_module: AshPolicyAccess.Check.Static, check_opts: check_opts}) do
...
#           AshPolicyAccess.Filter.strict_subset_of?(clause.filter, potential_matching.filter)
#     end
#   end
# end

# defimpl Inspect, for: AshPolicyAccess.Clause do
